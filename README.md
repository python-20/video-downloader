# Video Downloader
This application will be used to download various videos from YouTube (For now), and maybe one day be able to download stuff off Reddit, Instagram, Twitter, and more
...
```
Use clear variable names such as video_download()
```
